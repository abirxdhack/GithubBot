...
class SmartButtons:
    ...
    def button(self, text, callback_data=None, url=None, pay=None,
               ...
               request_location=None, simple_web_view=None,
               user_profile=None, position=None):
        try:
            if callback_data is not None:
                ...
                btn = (
                    user_profile if isinstance(user_profile, InputKeyboardButtonUserProfile)
                    else InputKeyboardButtonUserProfile(text, user_profile)
                )
            elif request_phone:
            ...
            LOGGER.error(f"SmartButtons.button failed: {e}")
            raise
